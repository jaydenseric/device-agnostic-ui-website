...
import Example1, { css as cssExample1 } from "./examples/Para/1.mjs";
...
/** React component for the `Para` component page. */
export default function PageComponentPara() {
  return h(PageComponent, {
    ...
    examples: h(CodeExample, {
      caption: "A paragraph.",
      url: "/components/examples/Para/1.mjs",
      Example: Example1,
      screenshot: true,
    }),
  });
